...
page(2)
text(78,54,'The model picks a test.',48,'Serif')
text(78,108,'The app checks the result.',48,'Serif')
for y,label,size,font,col in [(220,'Old + new prompts',25,'Sans',INK),(295,'GPT-OSS-120B',35,'Serif',AMBER),(337,'Nebius Token Factory',21,'Sans',INK),(412,'JSON: test name + reason',25,'Sans',INK),(486,'App loads saved test results',25,'Sans',INK),(560,'Scores back → next choice',25,'Sans',INK)]:
    text(373,y,label,size,font,col,'center')
for y in [260,372,452,526]: text(373,y,'↓',25,'Sans',MUTED,'center')
for y,label,col in [(281,'GPT-OSS-120B',AMBER),(325,'chooses the test.',INK),(369,'Qwen3-30B',AMBER),(413,'supplied the answers.',INK)]: text(733,y,label,34,'Serif',col)
for y,label in [(488,'Planning runs live.'),(517,'Qwen outputs were saved earlier.')]: text(733,y,label,19,color=MUTED)
end()
page(3)
